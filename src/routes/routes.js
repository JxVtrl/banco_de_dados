...
router.put('/uf/updateOne', async (req, res) => {
    ufController.updateOne( req, res, client );
})
// ================= fim rotas uf =========================
// ================= rotas rodovia =========================
...
router.delete('/rodovia/deleteOne', async ( req, res ) => {
    rodoviaController.deleteOne( req, res, client );
})

router.put('/rodovia/updateOne', async (req, res) => {
    rodoviaController.updateOne( req, res, client );
})
...
router.delete('/tipoRegiao/deleteOne', async ( req, res ) => {
    tipoRegiaoController.deleteOne( req, res, client );
})

router.put('/tipoRegiao/updateOne', async ( req, res ) => {
    tipoRegiaoController.updateOne( req, res, client );
})
...
router.delete('/classeTaxonomica/deleteOne', async ( req, res ) => {
    classeTaxonomicaController.deleteOne( req, res, client );
})

router.put('/classeTaxonomica/updateOne', async ( req, res ) => {
    classeTaxonomicaController.updateOne( req, res, client );
})
...
router.delete('/situacaoFinalAnimal/deleteOne', async ( req, res ) => {
    situacaoFinalAnimalController.deleteOne( req, res, client );
})

router.put('/situacaoFinalAnimal/updateOne', async ( req, res ) => {
    situacaoFinalAnimalController.updateOne( req, res, client );
})
...
router.delete('/tipoPavimento/deleteOne', async ( req, res ) => {
    tipoPavimentoController.deleteOne( req, res, client );
})

router.put('/tipoPavimento/updateOne', async ( req, res ) => {
    tipoPavimentoController.updateOne( req, res, client );
})
...
router.delete('/especie/deleteOne', async ( req, res ) => {
    especieController.deleteOne( req, res, client );
})

router.put('/especie/updateOne', async ( req, res ) => {
    especieController.updateOne( req, res, client );
})
...
router.delete('/categoria/deleteOne', async ( req, res ) => {
    categoriaController.deleteOne( req, res, client );
})

router.put('/categoria/updateOne', async ( req, res ) => {
    categoriaController.updateOne( req, res, client );
})
